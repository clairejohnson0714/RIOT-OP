...
case "$option" in
   "test") echo "using test scheduler"
	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:edge5,BloomFilterBolt:edge5,InterpolationBolt:worker2,JoinBolt:worker2,AnnotationBolt:worker2,CsvToSenMLBolt:core,PublishBolt:core,sink:core"
   ;;
   "default") echo "using default scheduler"
	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:worker2,BloomFilterBolt:edge5,InterpolationBolt:worker2,JoinBolt:edge5,AnnotationBolt:worker2,CsvToSenMLBolt:core,PublishBolt:core,sink:core"
   ;;
   "resource") echo "using resource aware scheduler"
	# Resource aware 
   	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:edge5,BloomFilterBolt:edge5,InterpolationBolt:edge5,JoinBolt:edge5,AnnotationBolt:edge5,CsvToSenMLBolt:edge5,PublishBolt:worker2,sink:core"
   ;;

   "amnis") echo "using amnis scheduler"
 	# Amnis methods
   	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:edge5,BloomFilterBolt:edge5,InterpolationBolt:edge5,JoinBolt:edge5,AnnotationBolt:worker2,CsvToSenMLBolt:worker2,PublishBolt:worker2,sink:core"
   ;;
   "coda") echo "using coda scheduler"
 	# coda methods
   	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:edge5,BloomFilterBolt:edge5,InterpolationBolt:edge5,JoinBolt:edge5,AnnotationBolt:edge5,CsvToSenMLBolt:worker2,PublishBolt:worker2,sink:core"
   ;;
   "beaver") echo "using beaver scheduler"
 	# beaver 
	topologyMap="spout1:core1,SenMlParseBolt:edge5,RangeFilterBolt:edge5,BloomFilterBolt:edge5,InterpolationBolt:edge5,JoinBolt:edge5,AnnotationBolt:worker2,CsvToSenMLBolt:core,PublishBolt:core,sink:core"
   ;;
